...
author: "<center> Camila Farias Amorim, Fernanda O. Novais, Ba T. Nguyen, Ana M. Misic, Lucas P. Carvalho, Edgar M. Carvalho, Daniel P. Beiting*, Phillip Scott* <center><br>"
...
```{r tximports}
# capturing Ensembl transcript IDs (tx) and gene symbols ("gene_name") from EnsDb.Hsapiens.v86 annotation package
...
## Volcano Plot for CL vs. HS  - \textcolor{red}{Figure 1B}
...
## Top 100 upregulated genes in CL vs. HS - \textcolor{red}{Figure S1}
...
```{r parasite reads by disease status}
list.patients <- 1:21
list.healthy <- 1:7
...
paths.patients.parasite <- file.path("../readMapping/Lbraz", c(paste0("parasite_CL", list.patients)), "abundance.h5")
paths.healthy.parasite <- file.path("../readMapping/Lbraz", c(paste0("parasite_HS", list.healthy)), "abundance.h5") 
...
```{r parasite reads by outcome}
list <- 1:21
list <- str_pad(list, 2, pad = "0")
paths.patients.parasite <- file.path("../readMapping/Lbraz", c(paste0("parasite_CL", list)), "abundance.h5") 
...
#modifying the patient-level data to include parasite counts, as well as expresion of selected ViTALs
ViTALs_selected <- Txi.lesion.coding.onlypatients$abundance %>%
  ...
  dplyr::filter(geneSymbol == "PRF1" | geneSymbol =="GNLY" | geneSymbol == "GZMB" | geneSymbol =="IFNG"
                | geneSymbol == "UNC13A" | geneSymbol =="KIR2DL4" | geneSymbol == "CCL4" | geneSymbol =="APOBEC3A")
...
## correlation of parasite transcripts with ViTALs - \textcolor{red}{Figure 5D}
```{r correlation}
...
```{r sample info Christensen}
import <- read_tsv("StudyDesign_Christensen_plosNTD_2016.txt")
import %>% dplyr::filter(disease == "CL" & treatment_outcome != "unclear") %>%  
  gt() %>%
  tab_header(title = md("Clinical metadata from patients with cutaneous leishmaniasis (CL) in Christensen et al."),
...
Txi.lesion.Christensen <- tximport(paths.all, 
                              type = "kallisto", 
                              tx2gene = Tx, 
                              txOut = FALSE,
                              ignoreTxVersion = TRUE,
...
Txi.lesion.Christensen.onlypatients <- tximport(paths.patients, 
                                           type = "kallisto", 
                                           tx2gene = Tx, 
                                           txOut = FALSE,
                                           ignoreTxVersion = TRUE,
...
```{bash filtering out host reads Christensen, eval=FALSE}
# first the healthy subjects (HS).
kneaddata -i SRR3162842.fastq.gz -db /data/reference_db/Homo_sapiens/Ensembl/GRCh37/Sequence/Bowtie2Index -o SRR3162842_filtered -t 24 
kneaddata -i SRR3162843.fastq.gz -db /data/reference_db/Homo_sapiens/Ensembl/GRCh37/Sequence/Bowtie2Index -o SRR3162843_filtered -t 24 
kneaddata -i SRR3162844.fastq.gz -db /data/reference_db/Homo_sapiens/Ensembl/GRCh37/Sequence/Bowtie2Index -o SRR3162844_filtered -t 24 
kneaddata -i SRR3162845.fastq.gz -db /data/reference_db/Homo_sapiens/Ensembl/GRCh37/Sequence/Bowtie2Index -o SRR3162845_filtered -t 24 
kneaddata -i SRR3162846.fastq.gz -db /data/reference_db/Homo_sapiens/Ensembl/GRCh37/Sequence/Bowtie2Index -o SRR3162846_filtered -t 24 
kneaddata -i SRR3162847.fastq.gz -db /data/reference_db/Homo_sapiens/Ensembl/GRCh37/Sequence/Bowtie2Index -o SRR3162847_filtered -t 24 
kneaddata -i SRR3162848.fastq.gz -db /data/reference_db/Homo_sapiens/Ensembl/GRCh37/Sequence/Bowtie2Index -o SRR3162848_filtered -t 24 
kneaddata -i SRR3162849.fastq.gz -db /data/reference_db/Homo_sapiens/Ensembl/GRCh37/Sequence/Bowtie2Index -o SRR3162849_filtered -t 24 
kneaddata -i SRR3162850.fastq.gz -db /data/reference_db/Homo_sapiens/Ensembl/GRCh37/Sequence/Bowtie2Index -o SRR3162850_filtered -t 24 
kneaddata -i SRR3162851.fastq.gz -db /data/reference_db/Homo_sapiens/Ensembl/GRCh37/Sequence/Bowtie2Index -o SRR3162851_filtered -t 24

# then the cutaneous leishmaniasis (CL) patients
kneaddata -i SRR3162852.fastq.gz -db /data/reference_db/Homo_sapiens/Ensembl/GRCh37/Sequence/Bowtie2Index -o SRR3162852_filtered -t 24 
kneaddata -i SRR3162853.fastq.gz -db /data/reference_db/Homo_sapiens/Ensembl/GRCh37/Sequence/Bowtie2Index -o SRR3162853_filtered -t 24 
kneaddata -i SRR3162854.fastq.gz -db /data/reference_db/Homo_sapiens/Ensembl/GRCh37/Sequence/Bowtie2Index -o SRR3162854_filtered -t 24 
kneaddata -i SRR3162855.fastq.gz -db /data/reference_db/Homo_sapiens/Ensembl/GRCh37/Sequence/Bowtie2Index -o SRR3162855_filtered -t 24 
kneaddata -i SRR3162856.fastq.gz -db /data/reference_db/Homo_sapiens/Ensembl/GRCh37/Sequence/Bowtie2Index -o SRR3162856_filtered -t 24 
kneaddata -i SRR3162857.fastq.gz -db /data/reference_db/Homo_sapiens/Ensembl/GRCh37/Sequence/Bowtie2Index -o SRR3162857_filtered -t 24 
kneaddata -i SRR3162858.fastq.gz -db /data/reference_db/Homo_sapiens/Ensembl/GRCh37/Sequence/Bowtie2Index -o SRR3162858_filtered -t 24 
kneaddata -i SRR3162859.fastq.gz -db /data/reference_db/Homo_sapiens/Ensembl/GRCh37/Sequence/Bowtie2Index -o SRR3162859_filtered -t 24 
kneaddata -i SRR3162860.fastq.gz -db /data/reference_db/Homo_sapiens/Ensembl/GRCh37/Sequence/Bowtie2Index -o SRR3162860_filtered -t 24 
kneaddata -i SRR3162861.fastq.gz -db /data/reference_db/Homo_sapiens/Ensembl/GRCh37/Sequence/Bowtie2Index -o SRR3162861_filtered -t 24 
kneaddata -i SRR3162862.fastq.gz -db /data/reference_db/Homo_sapiens/Ensembl/GRCh37/Sequence/Bowtie2Index -o SRR3162862_filtered -t 24 
kneaddata -i SRR3162863.fastq.gz -db /data/reference_db/Homo_sapiens/Ensembl/GRCh37/Sequence/Bowtie2Index -o SRR3162863_filtered -t 24 
kneaddata -i SRR3162867.fastq.gz -db /data/reference_db/Homo_sapiens/Ensembl/GRCh37/Sequence/Bowtie2Index -o SRR3162867_filtered -t 24 
kneaddata -i SRR3162864.fastq.gz -db /data/reference_db/Homo_sapiens/Ensembl/GRCh37/Sequence/Bowtie2Index -o SRR3162864_filtered -t 24 
kneaddata -i SRR3162865.fastq.gz -db /data/reference_db/Homo_sapiens/Ensembl/GRCh37/Sequence/Bowtie2Index -o SRR3162865_filtered -t 24 
kneaddata -i SRR3162866.fastq.gz -db /data/reference_db/Homo_sapiens/Ensembl/GRCh37/Sequence/Bowtie2Index -o SRR3162866_filtered -t 24 
kneaddata -i SRR3162868.fastq.gz -db /data/reference_db/Homo_sapiens/Ensembl/GRCh37/Sequence/Bowtie2Index -o SRR3162868_filtered -t 24 
kneaddata -i SRR3162869.fastq.gz -db /data/reference_db/Homo_sapiens/Ensembl/GRCh37/Sequence/Bowtie2Index -o SRR3162869_filtered -t 24
kneaddata -i SRR3162870.fastq.gz -db /data/reference_db/Homo_sapiens/Ensembl/GRCh37/Sequence/Bowtie2Index -o SRR3162870_filtered -t 24 
kneaddata -i SRR3162871.fastq.gz -db /data/reference_db/Homo_sapiens/Ensembl/GRCh37/Sequence/Bowtie2Index -o SRR3162871_filtered -t 24 
kneaddata -i SRR3162872.fastq.gz -db /data/reference_db/Homo_sapiens/Ensembl/GRCh37/Sequence/Bowtie2Index -o SRR3162872_filtered -t 24 
kneaddata -i SRR3162873.fastq.gz -db /data/reference_db/Homo_sapiens/Ensembl/GRCh37/Sequence/Bowtie2Index -o SRR3162873_filtered -t 24 
kneaddata -i SRR3162874.fastq.gz -db /data/reference_db/Homo_sapiens/Ensembl/GRCh37/Sequence/Bowtie2Index -o SRR3162874_filtered -t 24 
kneaddata -i SRR3162875.fastq.gz -db /data/reference_db/Homo_sapiens/Ensembl/GRCh37/Sequence/Bowtie2Index -o SRR3162875_filtered -t 24 
kneaddata -i SRR3162876.fastq.gz -db /data/reference_db/Homo_sapiens/Ensembl/GRCh37/Sequence/Bowtie2Index -o SRR3162876_filtered -t 24 
```

## mapping filtered reads to *L. braziliensis*
```{bash mapping reads to parasite for Christensen, eval=FALSE}
# first the healthy subjects (HS).
kallisto quant -i Leishmania_braziliensis_mhom_br_75_m2904.ASM284v2.cdna.all.index -o parasite_SRR3162842 -b 60 -t 24 SRR3162842_1_kneaddata.fastq SRR3162842_2_kneaddata.fastq &> parasite_SRR3162842.log
kallisto quant -i Leishmania_braziliensis_mhom_br_75_m2904.ASM284v2.cdna.all.index -o parasite_SRR3162843 -b 60 -t 24 SRR3162843_1_kneaddata.fastq SRR3162843_2_kneaddata.fastq &> parasite_SRR3162843.log
kallisto quant -i Leishmania_braziliensis_mhom_br_75_m2904.ASM284v2.cdna.all.index -o parasite_SRR3162844 -b 60 -t 24 SRR3162844_1_kneaddata.fastq SRR3162844_2_kneaddata.fastq &> parasite_SRR3162844.log
kallisto quant -i Leishmania_braziliensis_mhom_br_75_m2904.ASM284v2.cdna.all.index -o parasite_SRR3162845 -b 60 -t 24 SRR3162845_1_kneaddata.fastq SRR3162845_2_kneaddata.fastq &> parasite_SRR3162845.log
kallisto quant -i Leishmania_braziliensis_mhom_br_75_m2904.ASM284v2.cdna.all.index -o parasite_SRR3162846 -b 60 -t 24 SRR3162846_1_kneaddata.fastq SRR3162846_2_kneaddata.fastq &> parasite_SRR3162846.log
kallisto quant -i Leishmania_braziliensis_mhom_br_75_m2904.ASM284v2.cdna.all.index -o parasite_SRR3162847 -b 60 -t 24 SRR3162847_1_kneaddata.fastq SRR3162847_2_kneaddata.fastq &> parasite_SRR3162847.log
kallisto quant -i Leishmania_braziliensis_mhom_br_75_m2904.ASM284v2.cdna.all.index -o parasite_SRR3162848 -b 60 -t 24 SRR3162848_1_kneaddata.fastq SRR3162848_2_kneaddata.fastq &> parasite_SRR3162848.log
kallisto quant -i Leishmania_braziliensis_mhom_br_75_m2904.ASM284v2.cdna.all.index -o parasite_SRR3162849 -b 60 -t 24 SRR3162849_1_kneaddata.fastq SRR3162849_2_kneaddata.fastq &> parasite_SRR3162849.log
kallisto quant -i Leishmania_braziliensis_mhom_br_75_m2904.ASM284v2.cdna.all.index -o parasite_SRR3162850 -b 60 -t 24 SRR3162850_1_kneaddata.fastq SRR3162850_2_kneaddata.fastq &> parasite_SRR3162850.log
kallisto quant -i Leishmania_braziliensis_mhom_br_75_m2904.ASM284v2.cdna.all.index -o parasite_SRR3162851 -b 60 -t 24 SRR3162851_1_kneaddata.fastq SRR3162851_2_kneaddata.fastq &> parasite_SRR3162851.log

# then the cutaneous leishmaniasis (CL) patients
kallisto quant -i Leishmania_braziliensis_mhom_br_75_m2904.ASM284v2.cdna.all.index -o parasite_SRR3162852 -b 60 -t 24 SRR3162852_1_kneaddata.fastq SRR3162852_2_kneaddata.fastq &> parasite_SRR3162852.log
kallisto quant -i Leishmania_braziliensis_mhom_br_75_m2904.ASM284v2.cdna.all.index -o parasite_SRR3162853 -b 60 -t 24 SRR3162853_1_kneaddata.fastq SRR3162853_2_kneaddata.fastq &> parasite_SRR3162853.log
kallisto quant -i Leishmania_braziliensis_mhom_br_75_m2904.ASM284v2.cdna.all.index -o parasite_SRR3162854 -b 60 -t 24 SRR3162854_1_kneaddata.fastq SRR3162854_2_kneaddata.fastq &> parasite_SRR3162854.log
kallisto quant -i Leishmania_braziliensis_mhom_br_75_m2904.ASM284v2.cdna.all.index -o parasite_SRR3162855 -b 60 -t 24 SRR3162855_1_kneaddata.fastq SRR3162855_2_kneaddata.fastq &> parasite_SRR3162855.log
kallisto quant -i Leishmania_braziliensis_mhom_br_75_m2904.ASM284v2.cdna.all.index -o parasite_SRR3162856 -b 60 -t 24 SRR3162856_1_kneaddata.fastq SRR3162856_2_kneaddata.fastq &> parasite_SRR3162856.log
kallisto quant -i Leishmania_braziliensis_mhom_br_75_m2904.ASM284v2.cdna.all.index -o parasite_SRR3162857 -b 60 -t 24 SRR3162857_1_kneaddata.fastq SRR3162857_2_kneaddata.fastq &> parasite_SRR3162857.log
kallisto quant -i Leishmania_braziliensis_mhom_br_75_m2904.ASM284v2.cdna.all.index -o parasite_SRR3162858 -b 60 -t 24 SRR3162858_1_kneaddata.fastq SRR3162858_2_kneaddata.fastq &> parasite_SRR3162858.log
kallisto quant -i Leishmania_braziliensis_mhom_br_75_m2904.ASM284v2.cdna.all.index -o parasite_SRR3162859 -b 60 -t 24 SRR3162859_1_kneaddata.fastq SRR3162859_2_kneaddata.fastq &> parasite_SRR3162859.log
kallisto quant -i Leishmania_braziliensis_mhom_br_75_m2904.ASM284v2.cdna.all.index -o parasite_SRR3162860 -b 60 -t 24 SRR3162860_1_kneaddata.fastq SRR3162860_2_kneaddata.fastq &> parasite_SRR3162860.log
kallisto quant -i Leishmania_braziliensis_mhom_br_75_m2904.ASM284v2.cdna.all.index -o parasite_SRR3162861 -b 60 -t 24 SRR3162861_1_kneaddata.fastq SRR3162861_2_kneaddata.fastq &> parasite_SRR3162861.log
kallisto quant -i Leishmania_braziliensis_mhom_br_75_m2904.ASM284v2.cdna.all.index -o parasite_SRR3162862 -b 60 -t 24 SRR3162862_1_kneaddata.fastq SRR3162862_2_kneaddata.fastq &> parasite_SRR3162862.log
kallisto quant -i Leishmania_braziliensis_mhom_br_75_m2904.ASM284v2.cdna.all.index -o parasite_SRR3162863 -b 60 -t 24 SRR3162863_1_kneaddata.fastq SRR3162863_2_kneaddata.fastq &> parasite_SRR3162863.log
kallisto quant -i Leishmania_braziliensis_mhom_br_75_m2904.ASM284v2.cdna.all.index -o parasite_SRR3162864 -b 60 -t 24 SRR3162864_1_kneaddata.fastq SRR3162864_2_kneaddata.fastq &> parasite_SRR3162864.log
kallisto quant -i Leishmania_braziliensis_mhom_br_75_m2904.ASM284v2.cdna.all.index -o parasite_SRR3162865 -b 60 -t 24 SRR3162865_1_kneaddata.fastq SRR3162865_2_kneaddata.fastq &> parasite_SRR3162865.log
kallisto quant -i Leishmania_braziliensis_mhom_br_75_m2904.ASM284v2.cdna.all.index -o parasite_SRR3162866 -b 60 -t 24 SRR3162866_1_kneaddata.fastq SRR3162866_2_kneaddata.fastq &> parasite_SRR3162866.log
kallisto quant -i Leishmania_braziliensis_mhom_br_75_m2904.ASM284v2.cdna.all.index -o parasite_SRR3162867 -b 60 -t 24 SRR3162867_1_kneaddata.fastq SRR3162867_2_kneaddata.fastq &> parasite_SRR3162867.log
kallisto quant -i Leishmania_braziliensis_mhom_br_75_m2904.ASM284v2.cdna.all.index -o parasite_SRR3162868 -b 60 -t 24 SRR3162868_1_kneaddata.fastq SRR3162868_2_kneaddata.fastq &> parasite_SRR3162868.log
kallisto quant -i Leishmania_braziliensis_mhom_br_75_m2904.ASM284v2.cdna.all.index -o parasite_SRR3162869 -b 60 -t 24 SRR3162869_1_kneaddata.fastq SRR3162869_2_kneaddata.fastq &> parasite_SRR3162869.log
kallisto quant -i Leishmania_braziliensis_mhom_br_75_m2904.ASM284v2.cdna.all.index -o parasite_SRR3162870 -b 60 -t 24 SRR3162870_1_kneaddata.fastq SRR3162870_2_kneaddata.fastq &> parasite_SRR3162870.log
kallisto quant -i Leishmania_braziliensis_mhom_br_75_m2904.ASM284v2.cdna.all.index -o parasite_SRR3162871 -b 60 -t 24 SRR3162871_1_kneaddata.fastq SRR3162871_2_kneaddata.fastq &> parasite_SRR3162871.log
kallisto quant -i Leishmania_braziliensis_mhom_br_75_m2904.ASM284v2.cdna.all.index -o parasite_SRR3162872 -b 60 -t 24 SRR3162872_1_kneaddata.fastq SRR3162872_2_kneaddata.fastq &> parasite_SRR3162872.log
kallisto quant -i Leishmania_braziliensis_mhom_br_75_m2904.ASM284v2.cdna.all.index -o parasite_SRR3162873 -b 60 -t 24 SRR3162873_1_kneaddata.fastq SRR3162873_2_kneaddata.fastq &> parasite_SRR3162873.log
kallisto quant -i Leishmania_braziliensis_mhom_br_75_m2904.ASM284v2.cdna.all.index -o parasite_SRR3162874 -b 60 -t 24 SRR3162874_1_kneaddata.fastq SRR3162874_2_kneaddata.fastq &> parasite_SRR3162874.log
kallisto quant -i Leishmania_braziliensis_mhom_br_75_m2904.ASM284v2.cdna.all.index -o parasite_SRR3162875 -b 60 -t 24 SRR3162875_1_kneaddata.fastq SRR3162875_2_kneaddata.fastq &> parasite_SRR3162875.log
kallisto quant -i Leishmania_braziliensis_mhom_br_75_m2904.ASM284v2.cdna.all.index -o parasite_SRR3162876 -b 60 -t 24 SRR3162876_1_kneaddata.fastq SRR3162876_2_kneaddata.fastq &> parasite_SRR3162876.log
```

## Parasite reads by treatment outcome - \textcolor{red}{Figure 6B}
```{r parasite reads in Christensen}
paths.patients.Christensen.parasite <- file.path("../Christensen_plosNTD_2016/Lbraz", paste0("parasite_", targets.onlypatients$sample), "abundance.h5") 

Txi.lesion.Christensen.parasite <- tximport(paths.patients.Christensen.parasite,
                                            type = "kallisto", 
                                            txOut = TRUE,
                                            ignoreTxVersion = TRUE,
                                            countsFromAbundance = "lengthScaledTPM")
...
#modifying the patient-level data to include parasite counts, as well as expresion of selected ViTALs
ViTALs_selected_Christensen <- Txi.lesion.Christensen.onlypatients$abundance %>%
  as_tibble(rownames = "geneSymbol") %>%
  dplyr::filter(geneSymbol == "PRF1" | geneSymbol =="GNLY" | geneSymbol == "GZMB" | geneSymbol =="IFNG"
                | geneSymbol == "UNC13A" | geneSymbol =="KIR2DL4" | geneSymbol == "CCL4" | geneSymbol =="APOBEC3A")


geneSymbols_ViTALS_selected <- ViTALs_selected_Christensen$geneSymbol
ViTALs_selected_Christensen <- as.data.frame(t(ViTALs_selected_Christensen[,-1]))
colnames(ViTALs_selected_Christensen) <- geneSymbols_ViTALS_selected 

#number of reads remaining after removing host reads above
librarySize.CL <- c(5112799, 5138357, 9712437, 10867257, 7564381,
...
p2 <- ggplot(targets.onlypatients, aes(x=treatment_outcome, y=log2(parasiteTx_CPM_Christensen), fill=treatment_outcome)) +
  geom_boxplot(outlier.shape = NA) +
  labs(y="parasite transcripts (log2 CPM)", x = "Treatment outcome",
